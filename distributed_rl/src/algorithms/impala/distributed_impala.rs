//! Distributed IMPALA algorithm implementation.
//!
...
use crate::algorithms::distributed_algorithm::{
    DistributedAlgorithm, OffPolicyDistributed,
};
...
#[derive(Debug, Clone)]
pub struct DistributedIMPALA {
    config: IMPALAConfig,
}

impl DistributedIMPALA {
...
impl<B: AutodiffBackend> DistributedAlgorithm<B> for DistributedIMPALA {
...
// Mark as off-policy
impl<B: AutodiffBackend> OffPolicyDistributed<B> for DistributedIMPALA {}
...
mod tests {
    ...
    fn test_staleness_handling() {
        ...
        let result = <DistributedIMPALA as DistributedAlgorithm<B>>::handle_staleness(&impala, batch, 10);
