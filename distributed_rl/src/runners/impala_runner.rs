//! IMPALA runner with multi-actor architecture.
//!
//! This module provides `IMPALARunner`, a high-level API for multi-actor
...
//! # Type Aliases
//!
//! - `IMPALADiscrete<B>`: Feed-forward discrete
//! - `IMPALAContinuous<B>`: Feed-forward continuous
    ...
    B: AutodiffBackend,
{
    ...
    ///
    /// ```ignore
    /// let runner = IMPALADiscrete::new(config);
...
pub type IMPALADiscrete<B> = IMPALARunner<DiscretePolicy, FeedForward, B>;

/// Distributed IMPALA with continuous actions and feed-forward policy.
pub type IMPALAContinuous<B> =
    IMPALARunner<ContinuousPolicy, FeedForward, B>;

/// Distributed IMPALA with discrete actions and recurrent policy.
pub type RecurrentIMPALADiscrete<B> =
    IMPALARunner<DiscretePolicy, Recurrent, B>;

/// Distributed IMPALA with continuous actions and recurrent policy.
pub type RecurrentIMPALAContinuous<B> =
    IMPALARunner<ContinuousPolicy, Recurrent, B>;
